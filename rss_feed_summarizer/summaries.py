...
2-3 Sentence Summary:""")
    ...
    def summarize_article(self, article: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if cached_summary:
            ...
            # Preserve any existing publisher summary before augmenting with AI output
            if "original_summary" not in article and article.get("summary"):
                article["original_summary"] = article["summary"]
            article["ai_summary"] = cached_summary
